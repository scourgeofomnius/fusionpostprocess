/**
  ...
  $Revision: 43302 5ccca3f1379e076570c8caa9f7f2d81c115ec2ce $
...
function onOpen() {
  ...
  var ymax = getGlobalParameter("stock-upper-y")
  writeComment("stock y max is ")
  writeComment(ymax)
  var newFormat = createFormat({decimals:(unit == MM ? 3 : 4), forceDecimal:true, scale:(360 / ymax)});
  yOutput = createVariable({prefix:"A"}, newFormat);
